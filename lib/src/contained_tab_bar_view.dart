...
class ContainedTabBarView extends StatefulWidget {
  ...
  ContainedTabBarView({
    ...
    this.centerchild,
    this.centerProperties: const CenterProperties(),
    this.views,
...
class ContainedTabBarViewState extends State<ContainedTabBarView>
  ...
  List<Widget> _buildChildren(BoxConstraints constraints) {
    List<Widget> children = [
      ...
      Container(
        width: widget.centerProperties.width,
        height: widget.centerProperties.height,
        padding: widget.centerProperties.padding,
        child: widget.centerchild,
        color: widget.centerProperties.centerBackGroundColor,
      ),
  ...
  Widget _buildTabBarView(BoxConstraints constraints) {
    ...
    final EdgeInsets centerOuterPadding =
        widget.centerProperties.outerPadding.resolve(TextDirection.ltr);
    if (widget.tabBarProperties.position == TabBarPosition.left ||
        widget.tabBarProperties.position == TabBarPosition.right) {
      return Container(
        width: constraints.maxWidth -
            widget.tabBarProperties.height -
            widget.centerProperties.height -
            centerOuterPadding.top -
            centerOuterPadding.bottom -
            outerPadding.top -
            outerPadding.bottom,
        child: TabBarView(
          controller: _controller,
